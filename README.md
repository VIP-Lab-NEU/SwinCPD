...
| Component   | Required Version/Amount         |
|-------------|--------------------------------|
...
> **⚠️ The datasets provided here already contain synthesized raw images. If you are using your own synthesized raw images, please modify the sensor layout in `Preprocessing.py` to match the sensor layout you used when you synthesized the raw images.**
...
**🟦 Optional: Extra Functions in the AoLP Denoising Script**
...
> ⚠️ Please note that our denoising method only addresses noise caused by **inherent instabilities in numerical calculations** of polarization images, rather than common sensor noise. Therefore, our denoising method is based on **clean** I0, I45, I90, and I135 images. If your dataset has significant sensor noise in the I0, I45, I90, and I135 images, it is recommended to denoise them using an appropriate method first.
