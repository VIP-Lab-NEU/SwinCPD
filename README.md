...
> **⚠️ The datasets provided here already contain synthesized raw images. If you are using your own synthesized raw images, please modify the sensor layout in `Preprocessing.py` to match the sensor layout you used when synthesizing the raw images.**
