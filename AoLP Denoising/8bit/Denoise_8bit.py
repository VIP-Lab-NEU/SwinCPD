...
def denoise_with_bm3d(scene_name: str, base_dir: str = ".", sigma_psd: float = 0.1):
    ...
    # Save denoised DoLP (grayscale 8-bit)
    DoLP_denoised_save = DoLP_denoised * 255.0
    save_8bit_image("DoLP_denoised_bm3d.png", DoLP_denoised_save)

    # Save enhanced DoLP (grayscale 8-bit)
    DoLP_enhanced_save = DoLP_enhanced * 255.0
    save_8bit_image("DoLP_enhanced.png", DoLP_enhanced_save)
